...
![Header](/assets/img/htb/HTB-Worker/Header.png)
...
![Statistics](/assets/img/htb/HTB-Worker/Statistics.png)
...
![Nmap](/assets/img/htb/HTB-Worker/nmap.png)
...
![List](/assets/img/htb/HTB-Worker/Info_SVN_ls.png)
...
![Copy](/assets/img/htb/HTB-Worker/Info_SVN_cp.png)
...
![Worker](/assets/img/htb/HTB-Worker/Info_Worker.png)
...
![Moved](/assets/img/htb/HTB-Worker/Info_Moved.png)
...
![Devops](/assets/img/htb/HTB-Worker/Foothold_Devops.png)  
...
![Devops Authenticated](/assets/img/htb/HTB-Worker/Foothold_Devops_2.png) 

## Foothold

### Deploying our Webshell
From the Spectral Repository, we'll first create a new branch for us to make changes to.  
![Branch](/assets/img/htb/HTB-Worker/Foothold_Branch.png)  
...
![Upload](/assets/img/htb/HTB-Worker/Foothold_Upload.png)  
...
![Pull Request](/assets/img/htb/HTB-Worker/Foothold_PullRequest.png) 

Applying the final touches to the PR, we're able to approve it and get it deployed.  
![Pull Request Complete](/assets/img/htb/HTB-Worker/Foothold_PullRequest_2.png) 
...
![Credentials](/assets/img/htb/HTB-Worker/Foothold_Credentials.png)  
...
![Pipeline](/assets/img/htb/HTB-Worker/PrivEsc_Pipeline.png)  

Select `Azure Repos Git`  
![Pipeline 2](/assets/img/htb/HTB-Worker/PrivEsc_Pipeline_2.png)  
...
![Pipeline 3](/assets/img/htb/HTB-Worker/PrivEsc_Pipeline_3.png)  

### Root Flag
![Root Flag](/assets/img/htb/HTB-Worker/Root_Flag.png)  